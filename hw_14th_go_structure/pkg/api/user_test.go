...
// 假UserRepo實作CreateUser以達到user.go的UserRepository裡面的要求
...
func TestCreateNewUser(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			name: "should return an error because of missing weight_goal",
			request: api.NewUserRequest{
				Name:          "test user",
				WeightGoal:    "",
				Age:           20,
			...
			want: errors.New("user service - weight goal required"),
		}, {
